        ...
        <div class="menu-slider-wrapper">
            ...
            <div class="slider-area">
                <div class="slider-active owl-carousel">
                    <div class="single-slider single-slider-hm3 bg-img pt-170 pb-173" style="background-image: url({{asset('images/imgHome/img1.jpg')}}); max-height:595px">
                        <div class="slider-animation slider-content-style-3 fadeinup-animated">
                            <div style="background-color: rgba(0, 0, 0, 0.442); width:fit-content; padding:2.5rem">
                                <h2 class="animated" style="color:rgb(255, 255, 255)">Invention of <br>design platform</h2>
                                <h4 class="animated" style="color:rgb(255, 255, 255)">Best Product With warranty </h4>
                                <a class="electro-slider-btn btn-hover" href="product-details.html">Acheter</a>
                            </div>
                        </div>
                    </div>
                    <div class="single-slider single-slider-hm3 bg-img pt-170 pb-173" style="background-image: url({{asset('images/imgHome/img2.jpg')}}); max-height:595px">
                        <div class="slider-animation slider-content-style-3 fadeinup-animated">
                            <div style="background-color: rgba(248, 248, 248, 0.438); width:fit-content; padding:2.5rem">
                                <h2 class="animated" style="color:rgb(40, 38, 38)">Invention of <br>design platform</h2>
                                <h4 class="animated" style="color:rgb(40, 38, 38)">Best Product With warranty </h4>
                                <a class="electro-slider-btn btn-hover" href="product-details.html">Acheter</a>
                            </div>
                        </div>
                    </div>
...
@include('newLayouts.pages.HomeInc.topProduit')

<div class="banner-area wrapper-padding pt-30 pb-95">
    <div class="container-fluid">
        <div class="electro-fexible-banner bg-img" style="background-image: url({{ asset('images/imgHome/img3.jpg')}}); position: relative">
            <div style="width: 100%; height:100%; background-color: rgba(0, 0, 0, 0.726); position: absolute; z-index:2"></div>
            <div class="fexible-content" style="z-index: 20; position: relative">
                <h3 style="color: whitesmoke">Jouez avec la flexibilité</h3>
                <p style="color: whitesmoke">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    <br>are somooth, Super Shine.</p>
                <a class="btn-hover flexible-btn" style="color: whitesmoke" href="product-details.html">Buy Now</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="best-selling-left">
                    <div class="product-wrapper">
                        <div class="product-img-4">
                            <a href="#"><img src="{{asset('images/imgHome/pexels-pixabay-53422.jpg')}}" alt="" style="width: 870px; height:700px; object-fit:cover"></a>
                        ...
                        <div class="product-content-5 text-center">
                            <div style="background-color: rgba(0, 0, 0, 0.622); padding:3rem; width:fit-content;">
                                ...
                                <h4 style="color:white"><a href="product-details.html">Philps EcoCare H85</a></h4>
                                <span style="color:white">Électroménager</span>
                                <h5 style="color:white">11300FCFA</h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="coustom-row-3">
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-charlotte-may-5824836.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Verre en Frazi</a></h4>
                                        <h5>250000FCFA</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-charlotte-may-5825346.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Machine à Café Esca</a></h4>
                                        <h5>500000FCFA</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-charlotte-may-5825362.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Machine à Café Oireausih</a></h4>
                                        <h5>267000FCFA</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-charlotte-may-5825374.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Pile d'Assiette T-102</a></h4>
                                        <h5>132000FCFA</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-david-yohanes-1450903.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Mixeur C27F500</a></h4>
                                        <h5>102500FCFA</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('images/imgHome/pexels-monstera-production-6781117.jpg')}}" style="height:347px" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="product-details.html">Valucciano Tab</a></h4>
                                        <h5>250000FCFA</h5>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="product-wrapper product-wrapper-border mb-30">
                    ...
                    <div class="product-content-7">
                        ...
                        <div class="product-action-electro">
                            ...
                            <a class="animate-right" title="Compare" data-bs-toggle="modal" data-target="#exampleCompare" href="#">
