            ...
            <div class="col-lg-3 order-2 order-lg-1">
                <div class="shop-sidebar mr-50">
                    <div class="sidebar-widget mb-50">
                        <h3 class="sidebar-title">Rechercher Produits</h3>
                        <div class="sidebar-search">
                            <form method="post" action="{{route('boutiqueSearch')}}">
                                @csrf
                                <input placeholder="Rechercher Produit..." type="text" name="product_name">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-xl-3">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img src="{{ asset('upload/product/'.$product->image)}}" alt="" style="height: 250px; object-fit:cover">
                                                    </a>
                                                    <span>hot</span>
